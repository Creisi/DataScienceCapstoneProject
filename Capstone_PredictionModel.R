...
trigramDF<-read.csv("~/CapstoneClass/trigramDF.csv")[,-1]
...
GTCount<-(read.csv("~/CapstoneClass/GTCount.csv")[,-1])

#bring in the Corpus for the document term matrix used in the Freq function
masterData<-readLines("~/CapstoneClass/master.txt",encoding="UTF-8")
...
# to, hopfully, add some accuracey.
...
# Put in the Freq table stuff here.
      ...
      # ubse all recorded trigrams taht begin with bigram
